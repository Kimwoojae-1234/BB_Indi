...
후속 전체 경기 실행과 추가 UI 보정 결과는 [2026-09-26 게임플레이 검증](GAMEPLAY_VALIDATION.md)에 기록했다. 수동 1경기·Quick 3경기를 완료했고, 비활성 배치 표시·숨겨진 기록 탭·동적 행 스크롤 입력을 수정했다. 아래 표는 이전 전환 완료 시점의 검사 자료다.
