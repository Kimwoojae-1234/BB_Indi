...
2026-09-24 후속 작업: 이 구현은 `00aabf65`로 커밋되었다. 최상위 Canvas 구조 변경은 별도 작업으로 단계별 진행하며, 현재는 [1단계 배치·의존 관계 조사](../CanvasRestructure/STEP1_BASELINE.md)까지 완료했다. 아래는 이전 일괄 전환과 당시 검증 기록이다.
