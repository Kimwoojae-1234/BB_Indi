...
public class UIScrollView : MonoBehaviour
{
    ...
    public delegate void OnMovementNotification(ref Vector3 momentum, float percent);
    ...
    /// <summary>
    /// Draging 중일 때 방향과 얼만큼 드래그 됐는지를 알려준다.
    /// </summary>
    public OnMovementNotification onVerticalScrollMovement;
    public OnMovementNotification onHorizontalScrollMovement;
	...
	public virtual void UpdateScrollbars (bool recalculateBounds)
	{
        ...
        if (onHorizontalScrollMovement != null || onVerticalScrollMovement != null
            || horizontalScrollBar != null || verticalScrollBar != null)
        {
            ...
            if ((onHorizontalScrollMovement != null || horizontalScrollBar != null) && bmax.x > bmin.x)
            {
				Vector4 clip = mPanel.finalClipRegion;
                ...
                UpdateScrollbars(horizontalScrollBar, onHorizontalScrollMovement, contentMin, contentMax, contentSize, viewSize, false);
            }

            //if (verticalScrollBar != null && bmax.y > bmin.y)
            if ((onVerticalScrollMovement != null || verticalScrollBar != null) && bmax.y > bmin.y)
            {
				Vector4 clip = mPanel.finalClipRegion;
                ...
                UpdateScrollbars(verticalScrollBar, onVerticalScrollMovement, contentMin, contentMax, contentSize, viewSize, true);
            }
		}
	...
	protected void UpdateScrollbars(UIProgressBar slider, OnMovementNotification notification, float contentMin, float contentMax, float contentSize, float viewSize, bool inverted)
    {
		if (slider == null && notification == null) return;

		mIgnoreCallbacks = true;
		{
            float contentPadding, value;
...
// 					((contentPadding > 0.001f) ? contentMin / contentPadding : 1f);
            ...
            if (notification != null)
                notification(ref mMomentum, value);
		}
