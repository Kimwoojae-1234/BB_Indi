...
public class UIButton : UIButtonColor
{
    ...
    public UISprite ClickOtherSprite;
	...
	protected override void OnInit ()
	{
		...
		if (mSprite2D != null) mNormalSprite2D = mSprite2D.sprite2D;
        if (ClickOtherSprite != null) ClickOtherSprite.enabled = false;
	}
	...
	public override void SetState (State state, bool immediate)
	{
		...
		if (mSprite != null)
		{
			switch (state)
			{
                case State.Normal: SetSprite(mNormalSprite); if (ClickOtherSprite != null) ClickOtherSprite.enabled =false; break;
                case State.Hover: SetSprite(string.IsNullOrEmpty(hoverSprite) ? mNormalSprite : hoverSprite); if (ClickOtherSprite != null) ClickOtherSprite.enabled = false; break;
                case State.Pressed: SetSprite(pressedSprite); if (ClickOtherSprite != null) ClickOtherSprite.enabled = true; break;
                case State.Disabled: SetSprite(disabledSprite); if (ClickOtherSprite != null) ClickOtherSprite.enabled = false; break;
			}
		}
